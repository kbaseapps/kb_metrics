...
This KBase SDK module implements methods for generating various KBase metrics.
    ...
    GIT_COMMIT_HASH = "b36be19624d8099b0889807e02c6a73c91c0803d"
    ...
    def get_user_ws(self, ctx, params):
        ...
        # return variables are: return_records
        #BEGIN get_user_ws
        return_records = self.mdb_controller.get_user_ws(ctx['user_id'], params, ctx['token'])
        #END get_user_ws
    ...
    def get_user_narratives(self, ctx, params):
        ...
        return_records = self.mdb_controller.get_user_narratives(ctx['user_id'], params, ctx['token'])
    ...
    def get_user_numObjs(self, ctx, params):
        ...
        return_records = self.mdb_controller.get_user_numObjs(ctx['user_id'], params, ctx['token'])
    ...
    def get_user_logins(self, ctx, params):
        ...
        return_records = self.mdb_controller.get_user_logins(ctx['user_id'], params, ctx['token'])
        #END get_user_logins
